...
class PrometheusCollectorBase(collector.BaseCollector):
    """Base class for Prometheus-compatible collectors.

    This class contains the shared logic for collecting metrics from
    Prometheus or Prometheus-compatible APIs (like Aetos). Subclasses
    must implement __init__ to set up the specific client type.
    """

    # Subclasses must set collector_name and initialize self._conn
    collector_name = None
